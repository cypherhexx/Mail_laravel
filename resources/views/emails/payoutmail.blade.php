    ...
    <body>
        ...
        <table width="600" bgcolor="#f9f9f9" style="font-family: MyriadPro-Regular, 'Myriad Pro Regular', MyriadPro, 'Myriad Pro', Helvetica, Arial, sans-serif;">
            ...
            <thead>
                ...
                <td style="padding:22px 30px 18px 30px; border-bottom:2px solid #1e2064"><img src="{{url('img/cache/original/logo.png')}}"" height="60" alt="cloudmlmsoftware"></td>    
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding:30px 30px 10px 30px"><h2 style="color:#000;">$ {{$amount}} Your payout has been approved </h2></td>
