        ...
        <table width="600" bgcolor="#f9f9f9" style="font-family: MyriadPro-Regular, 'Myriad Pro Regular', MyriadPro, 'Myriad Pro', Helvetica, Arial, sans-serif;">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td style="padding:22px 30px 18px 30px; border-bottom:2px solid #1e2064"><img src="http://joe.cloudmlmsoftware.com/public/assets/images/sne-logo.png" height="60" alt="Sneha Matrimony"></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding:20px 30px">
                        ...
                        <b style="color:#000; font-size:16px;">Email : username here.. </b><br> 
