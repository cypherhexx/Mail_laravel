...
<div class="panel panel-flat" >
	<div class="panel-heading">
        ...
        <h4 class="panel-title">{{trans('report.joining_report')}}</h4>
     </div>
...
<div class="panel panel-flat" >
	<div class="panel-heading">
        ...
        <h4 class="panel-title">{{trans('report.joining_report_by_sponsor')}}</h4>
     </div>
   <div class="panel-body"> 
     <form action="{{URL::to('admin/joiningreportbysponsor')}}" method="post">
     	<input type="hidden" name="_token"  value="{{csrf_token()}}">
	...
	<div class="panel-heading">
        ...
        <h4 class="panel-title">{{trans('report.joining_report_by_country')}}</h4>
     </div>
   <div class="panel-body"> 
     <form action="{{URL::to('admin/joiningreportbycountry')}}" method="post">
     	<input type="hidden" name="_token"  value="{{csrf_token()}}">
     	...
     	<div class="form-group col-sm-6">
	     		...
	     		<div class="col-sm-6">
	     			 ...
	     			 {!! Form::select('country', $countries ,'US',['class' => 'form-control','id' => 'country']) !!}
