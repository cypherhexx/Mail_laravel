           ...
           <!--      <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-content width-350">
                        <div class="dropdown-content-heading">
                            ...
                            <ul class="icons-list">
                                <li><a href="{{url('admin/inbox#/u/mail/compose')}}"><i class="icon-compose"></i></a></li>
                            </ul>
                        </div>
...
<!-- ('admin/userprofiles/'.Auth::user()->username) -->
                    <ul class="dropdown-menu dropdown-menu-right">
                     @if(Auth::user()->id==1)
                        <li><a href="{{ URL::to('admin/userprofiles/'.Auth::user()->username) }}"><i class="icon-user-plus"></i>{{trans('all.my_profile')}}</a></li>
                    ...
                    @else 
                        ...
                        <li><a href="{{ URL::to('user/settings') }}"><i class="icon-cog5"></i> {{trans('all.account_settings')}}</a></li>
                    @endif
