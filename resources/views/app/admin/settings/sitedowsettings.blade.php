...
<div class="panel panel-flat" >
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Site Management</h4> 
                        </div>
...
$('.myform :checkbox').change(function() {
         ...
         alert("Are you sure want to up the site?");
         $.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } }); 
         $.ajax({
                 url: "{{URL::to('admin/sitemanagementsettings')}}",
                 type: "post",
     ...
     alert("Are you sure want to down the site?");
