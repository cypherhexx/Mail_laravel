                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="panel bg-danger-400 has-bg-image">
                                <div class="panel-body">
                                    ...
                                    <h3 class="no-margin text-semibold">  {{$currency_sy}}{{ $income}}  </h3>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="panel bg-blue-400 has-bg-image">
                                <div class="panel-body">
                                    ...
                                    <h3 class="no-margin text-semibold"> {{$currency_sy}}{{$credit}} </h3>
                                   
                                    <div class="text-muted text-size-small">{{trans('ewallet.total_credited_amount')}}</div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="panel bg-success-400 has-bg-image">
                                <div class="panel-body">
                                    ...
                                    <h3 class="no-margin text-semibold">{{$currency_sy}}{{$payout}}</h3>
