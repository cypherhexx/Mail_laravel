...
<!-- ./ tabs -->
{{-- Edit Blog Form --}}
<form id="fupload" class="form-horizontal" enctype="multipart/form-data"
	method="post"
				...
				<div
					...
					<div class="col-md-12">
						<label class="control-label" for="newscategory_id">{{
							trans("news.category") }}</label> <select
				...
				<div
					...
					<div class="col-lg-12">
						<label class="control-label" for="picture">{{
							trans("news.picture") }}</label> <input name="picture"
