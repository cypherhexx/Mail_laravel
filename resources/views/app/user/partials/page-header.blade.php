<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">{{$title}}</span> - {{$sub_title}}</h4>
		</div>
...
<!--comment on 1-->
			<!-- <li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="{{url('user/profile')}}"><i class="icon-user-lock"></i> View Profile</a></li>
					<li class="divider"></li>
