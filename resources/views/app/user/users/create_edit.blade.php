				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input class="form-control" tabindex="1"
							placeholder="{{ trans('users.name') }}" type="text"
							name="name" id="name"
            ...
            <div class="col-md-12">
                <div class="form-group {{{ $errors->has('username') ? 'has-error' : '' }}}">
                    <label class="col-md-2 control-label" for="username">{{
						trans('users.username') }}</label>
                    <div class="col-md-10">
                        <input class="form-control" type="username" tabindex="4"
                               placeholder="{{ trans('users.username') }}" name="username"
                               id="username"
				...
				<div class="form-group {{{ $errors->has('email') ? 'has-error' : '' }}}">
					...
					<div class="col-md-10">
						<input class="form-control" type="email" tabindex="4"
							placeholder="{{ trans('users.email') }}" name="email"
							id="email"
