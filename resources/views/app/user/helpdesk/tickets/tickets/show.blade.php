@extends('app.user.layouts.default') {{-- Web site Title --}} @section('title') {{{ $title }}} :: @parent @stop @section('page_class', 'sidebar-main-hidden ') @section('styles') @parent @endsection @section('sidebar') @parent @include('app.user.helpdesk.tickets.layout.sidebar') @endsection {{-- Content --}} @section('main')
        ...
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list" style="margin-top: 0px;">
                    <li>
                        <a class="btn btn-xs btn-default" id="edit_Ticket" href="{{url('/user/helpdesk/ticket/')}}/{{$ticket->id}}/edit"><i class="fa fa-edit" style="color:green;"> </i> Edit</a>
                    </li>
                  <!--   <li><a href="{{url('ticket/print/',$ticket->id)}}" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-print" > </i> Generate PDF</a></li> -->
                    ...
                    <li>
                        <div id="more-option" class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li id="delete"><a class="btn-delete-ticket-user" data-id="{{$ticket->id}}" href="javascript:void(0)"><i class="fa fa-trash-o" style="color:red;" > </i>Delete ticket</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
