...
<div class="panel-heading">
<h6 class="panel-title">
    <?php echo e(trans('profile.payout_info')); ?>
...
<div class="panel-body">                                
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label>
                    <?php echo e(trans('register.account_number')); ?>

                </label>
                <input class="form-control" name="account_number" type="text" value="<?php echo e($selecteduser->profile_info->account_number); ?>">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label>
                    <?php echo e(trans('register.bank_code')); ?>
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" name="bank_code" type="text" value="<?php echo e($selecteduser->profile_info->bank_code); ?>">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label>
                    <?php echo e(trans('register.paypal')); ?>

                </label>
                <input class="form-control" name="paypal" type="text" value="<?php echo e($selecteduser->profile_info->paypal); ?>">
                 
            </div>
            <div class="col-md-6">
                <label>
                    <?php echo e(trans('register.btc_wallet')); ?>

                </label>
                <input class="form-control" name="btc_wallet" type="text" value="<?php echo e($selecteduser->profile_info->btc_wallet); ?>">
