<?php $__env->startSection('page_class', 'sidebar-main-hidden '); ?> 
...
<div class="sidebar sidebar-secondary sidebar-default">
    <div class="sidebar-content">
        ...
        <div class="sidebar-category">
            ...
            <div class="category-content">
                <a class="btn bg-indigo-400 btn-block" href="#" id="composeMailbtn">
                   <?php echo e(trans('mail.compose_mail')); ?>
        ...
        <div class="sidebar-category">
            <div class="category-title">
                <span>
                    <?php echo e(trans('mail.navigation')); ?>
                ...
                <ul class="navigation navigation-alt navigation-accordion no-padding-bottom">
                    ...
                    <li class="">
                        <a href="#" id="showInBox">
                           ...
                           <?php echo e(trans('mail.inbox')); ?>

                            <span class="badge badge-success">
                                <?php echo e($unread_count); ?>
                    ...
                    <li>
                        <a href="#" id="showOutBox">
                            ...
                            <?php echo e(trans('mail.send_mail')); ?>
        ...
        <div class="sidebar-category">
            <div class="category-title">
                <span>
                   <?php echo e(trans('mail.latest_messages')); ?>
            ...
            <div class="category-content no-padding">
                <ul class="media-list media-list-linked left-mail-links">
                    ...
                    <?php $__currentLoopData = $filtered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="media">
                        <a href="#" class="media-link left-mail-link" data-mailid="<?php echo e(Crypt::encrypt($mail->id)); ?>" data-emailid="<?php echo e($mail->email); ?>"  data-subject="<?php echo e($subject); ?>" data-message="<?php echo e($message); ?>" data-username="<?php echo e($mail->username); ?>" data-datetime="<?php echo e($mail->created_at); ?>" data-profilepic="<?php echo e($profilepic); ?>" data-totalmailfromuser="<?php echo e($mail->id); ?>">
                            <div class="media-left">
                                <img alt="" class="img-circle img-md" src="<?php echo e(url('img/cache/profile/')); ?>/<?php echo e($profilepic); ?>"/>
                            </div>
                            <div class="media-body">
                                <span class="media-heading text-semibold">
                                   <?php echo e($mail->username); ?>

                                </span>
                                <span class="text-muted">
                                   <?php echo e(str_limit(strip_tags($subject), $limit = 40, $end = '...')); ?>
...
<div id="email-page">
                        ...
                        <!-- Single mail -->
                            <div class="panel panel-white" id="single-compose" style="display: none;">
                                <form class="mailcomposeform" action="<?php echo e(url('admin/register')); ?>" method="POST" name="parsley-mail">
                                <!-- Mail toolbar -->
                                    ...
                                    <div class="navbar navbar-default">
                                        ...
                                        <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                                            <div class="btn-group navbar-btn">
                                                <button type="submit" class="submitmail btn bg-blue"><i class="icon-checkmark3 position-left"></i> <?php echo e(trans('mail.send_mail')); ?></button>
                                            </div>

                                            <div class="btn-group navbar-btn">

                                                <button type="button" class="btn btn-default button-email-compose-cancel"><i class="icon-cross2"></i> <span class="hidden-xs position-right"><?php echo e(trans('mail.cancel')); ?></span></button>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="no-padding">
                                                    <input type="text" name="to" id="to" class="tagsinput-typeahead form-control autocompleteusersforemail" required="required" data-parsley-required-message = "<?php echo e(trans("all.at_least_one_reciepient_required")); ?>" placeholder="Add recipients" data-role="tagsinput" />
                                                </td>

                                            </tr>
                                            <tr>
                                                <td><?php echo e(trans('mail.subject')); ?>:</td>
                                                <td class="no-padding"><input type="text" name="subject" class="form-control" required="required" placeholder="Add subject" data-parsley-required-message = "<?php echo e(trans("all.specify_email_subject")); ?>"></td>
...
<div class="panel panel-white" id="maillist" style="display: none;">
    <div class="panel-heading">
        <h6 class="panel-title">
            <?php echo e(trans('mail.my_inbox')); ?>

        </h6>
        <div class="heading-elements not-collapsible">
            <span class="label bg-blue heading-text">
                <?php echo e($unread_count); ?> <?php echo e(trans('mail.unread_items')); ?>
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                           <?php echo e(trans('mail.page')); ?> <?php echo e($all_mail->currentPage()); ?>

                        </span>
                        <?php echo e(trans('mail.with')); ?>

                        <span class="text-semibold">
                            <?php echo e($all_mail->perPage()); ?> <?php echo e(trans('mail.items')); ?>

                        </span>
                    </p>
                    <div class="btn-group navbar-left navbar-btn">

                        <?php echo e($all_mail->links()); ?>
    ...
    <div class="table-responsive">
        <table class="table table-inbox">
            <tbody class="rowlink" data-link="row">
                <?php if($limit_mail>0): ?>
                                    <?php $__currentLoopData = $all_mail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    $message = preg_replace('/(\>)\s*(\<)/m', '$1$2', $mail->message);
                                     ...
                                     ?>
                <tr class="mail-link <?php echo e($readClass); ?>" data-mailid="<?php echo e(Crypt::encrypt($mail->id)); ?>" data-emailid="<?php echo e($mail->email); ?>"  data-subject="<?php echo e($subject); ?>" data-message="<?php echo e($message); ?>" data-username="<?php echo e($mail->username); ?>" data-datetime="<?php echo e($mail->created_at); ?>" data-profilepic="<?php echo e($profilepic); ?>" data-totalmailfromuser="<?php echo e($mail->id); ?>">
                    ...
                    <td class="table-inbox-image">
                        <img alt="" class="img-circle img-xs" src="<?php echo e(url('img/cache/profile/')); ?>/<?php echo e($profilepic); ?>"/>
                    ...
                    <td class="table-inbox-message">
                        ...
                        <span class="table-inbox-preview">
                            <?php echo preg_replace('/\s+/', ' ',strip_tags($message)); ?>
                    ...
                    <td class="table-inbox-time">
                        <?php echo e(Date('h:i A',strtotime($mail->created_at))); ?>
                ...
                <tr class="unread">
                    <td class="text-center">
                        <?php echo e(trans('mail.you_have_no_messages')); ?>
...
<div class="panel panel-white" id="outlist" style="display: none;">
        ...
        <div class="navbar navbar-default">
            ...
            <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                           <?php echo e(trans('mail.page')); ?> <?php echo e($all_out_mail->currentPage()); ?>

                        </span>
                        <?php echo e(trans('mail.with')); ?>

                        <span class="text-semibold">
                            <?php echo e($all_out_mail->perPage()); ?> <?php echo e(trans('mail.items')); ?>

                        </span>
                    </p>
                    <div class="btn-group navbar-left navbar-btn">

                        <?php echo e($all_out_mail->links()); ?>
    ...
    <div class="table-responsive">
        <table class="table table-inbox">
            <tbody class="rowlink" data-link="row">
                <?php if($limit_out_mail>0): ?>
                                    <?php $__currentLoopData = $all_out_mail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
