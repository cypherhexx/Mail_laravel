...
<div class="row">
    <div class="col-md-6">
<div class="required form-group has-feedbackX has-feedback-leftx <?php echo e($errors->has('account_number') ? ' has-error' : ''); ?>">
    <?php echo Form::label('Bank code', trans("register.bank_code"), array('class' => 'control-label')); ?> <?php echo Form::text('bank_code', null !==(Input::old('bank_code')) ? Input::old('bank_code') : $selecteduser->profile_info->bank_code, ['class' => 'form-control','id' => 'bank_code','data-parsley-required-message' => trans("all.please_enter_bank_code"),'data-parsley-group' => 'block-1']); ?>
