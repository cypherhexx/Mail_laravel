            ...
            <fieldset> 
              ...
              <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
                  <li class="nav-item active"><a href="#steps-planpurchase-tab1" class="nav-link  steps-plan-payment active " data-toggle="tab" data-payment='cheque' ><?php echo e(trans('products.cheque')); ?></a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active  " id="steps-planpurchase-tab1">
                    <input type="hidden" name="steps_plan_payment" value="cheque" data-parsley-group="block-1">
                     <?php echo e(trans('products.send_your_payment_checque_to_the_company')); ?>  <code><?php echo e(trans('products.order_will_process_after_payment_received')); ?>  </code>, <?php echo e(trans('product.thanks')); ?>.
                     <br><br>
                  ...
                  <div class="tab-pane fade" id="steps-planpurchase-tab2">
                     Your current<code><b> balance is  <?php echo e($currency_sy); ?><?php echo e($balance); ?></b></code>
                     <?php echo e(trans('products.ewallet_comment')); ?>
