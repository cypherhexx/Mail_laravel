    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements not-collapsible">
            <span class="label bg-blue heading-text">
                <?php echo e($unread_count); ?> UNREAD ITEMS
            </span>
        </div>
    </div>
    <div class="panel-toolbar panel-toolbar-inbox">
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                         Page   <?php echo e($all_mail->currentPage()); ?>

                        </span>
                        with
                        <span class="text-semibold">
                            <?php echo e($all_mail->perPage()); ?>  Items
                        </span>
                    </p>
        ...
        <div class="navbar navbar-default">
            ...
            <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                           Page <?php echo e($all_out_mail->currentPage()); ?>

                        </span>
                       with
                        <span class="text-semibold">
                            <?php echo e($all_out_mail->perPage()); ?> items
                        </span>
                    </p>
                    <div class="btn-group navbar-left navbar-btn">
 ...
 $('.table-inbox').on('click', '.mail-link td:not(".table-inbox-checkbox,.table-inbox-star")', function(e) {
    ...
    'mark-as-read/'+mail_id,
       ...
       function(response) {
                    ...
                    if(this_context.hasClass('unread')){
                
                        this_context.removeClass('unread');
                        $('.badge-success').html($('.badge-success').html()-1);
                        $('.bg-warning-400').html($('.bg-warning-400').html()-1);
                    } 
