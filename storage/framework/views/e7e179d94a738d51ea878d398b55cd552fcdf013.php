...
<head>
    ...
    <!-- Favicon /-->
    <link rel="shortcut icon" href="<?php echo e(url('img/cache/original/'.$logo_ico)); ?>" type="image/x-icon" /> <!-- Favicon /-->
    <!-- Facebook Metadata /-->
    ...
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
     <title><?php $__env->startSection('title'); ?> <?php echo e($company_name); ?><?php echo $__env->yieldSection(); ?></title>
